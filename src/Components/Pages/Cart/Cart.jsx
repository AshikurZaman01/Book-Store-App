...
import { crearCart, decreaseQuantity, increaseQuantity, removeFromCart } from "../../../Redux/Features/Cart/cartSlice";
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                            ...
                            <div className="flex flex-1 flex-wrap items-end justify-between space-y-2 text-sm">
                              <div className="flex items-center">
                                <button onClick={() => handleDecreaseQuantity(product)} className="font-medium text-indigo-600 hover:text-indigo-500">-</button>
                                <span className="mx-2">{product.quantity}</span>
                                <button onClick={() => handleIncreaseQuantity(product)} className="font-medium text-indigo-600 hover:text-indigo-500">+</button>
                              </div>
